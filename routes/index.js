...
router.get('/futruelist', function (req, res, next) {
    var json = [
        {
            'id': 1,
            'name': '期货1'
...
router.get('/future/fresh', function (req, res, next) {
    var id = req.query.id;
    var length = Number(req.query.length) + 1;
    var json = {
        'x': length,
...
router.post('/future', function (req, res, next) {
    var id = req.query.id;
    var json = {
        'id': id,
        'name': id,
